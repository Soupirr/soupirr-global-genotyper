...
a = Analysis(
    ...
    hooksconfig={},
    runtime_hooks=[],
    excludes=['matplotlib', 'statsmodels', 'jedi', 'tkinter', '_tkinter', 'IPython', 'notebook', 'pytest', 'torch', 'torchvision', 'torchaudio', 'torch.distributed', 'torch.cuda', 'scipy'],
    noarchive=False,
)
